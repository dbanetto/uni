...
import RobotParser.RobotProgramNode;
...
public class World {
    ...
    private Game.Robot[] robots;

    public World() {
        robots = new Game.Robot[]{null,
                new Game.Robot(this, 0, 0, "red"),
                new Game.Robot(this, SIZE - 1, SIZE - 1, "blue")};
    }
    ...
    public void loadRobotProgram(int id, File code) {
        ...
        if (prog != null) {
            System.out.println("Game.Robot " + id + " now has program: ");
    ...
    public Game.Robot getRobot(int id) {
     ...
     */
    public Game.Robot getOtherRobot(Game.Robot robot) {
