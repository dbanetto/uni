...
could. We also saw risks involving our scheduling of our team and other aspects
...
Settling on the IID model our team used it to some effect. We planned to use
the first iteration to build a basic skeleton of how the components are laid out
and try to make it as a launch pad to iterate on features and functionality in
later iterations. After completing the first iteration we displayed our system
to our client for feedback. 
