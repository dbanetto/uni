...
The Spiral Model is a process model that Barry Boehm described in 1986 \cite{Boehm:1988}.
The model has the core theme of risk management and analysis which neither
Waterfall or V-Model directly tackled.
Spiral model also has ideas from both sequential and iterative methods with
producing multiple prototypes of the product over the course of the whole project 
while also linearly going through the software development cycle with the
addition of steps to review, plan the next iteration of the prototype as well as
...
\vskip 0.5cm}}
\caption{\protect\label{xyz}  Spiral Model}
\end{figure}
