...
\end{lstlisting}
    ...
    % ( \href{http://whiley.org/play/?id=DzLm1T}{Try snippet} ) FIXME: only use
    % if consistent & alt version available 
    }
\end{figure}
...
% overview of static analysis techniques, e.g. partial ordered sets, lattices
...
% Covers the literature review and compare current solution to similar projects
