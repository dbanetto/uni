...
public class BellsPizzaSimulation {
    ...
    public static final int NUMBER_OF_CYCLISTS = 3;
    /**
    ...
    private void loadDestinations() {
        try {
            ...
            System.out.println("Reading from destination file failed: " + e);
        }
    }
    ...
    private void runTests() {
        try {
            ...
            System.out.println("Opening log file failed: " + e);
        }
    }
    ...
    private double run(Queue<Pizza> queue, Scanner logFile) {
         ...
         */
        Queue<Cyclist> cyclists = new HeapArrayQueue<Cyclist>();
        for (int i = 0; i < NUMBER_OF_CYCLISTS; i++)
            cyclists.offer(new Cyclist());
        ...
        while (logFile.hasNext()) {
            ...
            if (time > cyclists.peek().AvailableAt && !queue.isEmpty()) {

                // obtain next pizza from the queue
                Pizza deliveredPizza = queue.poll();
                Cyclist deliverer = cyclists.poll();
                ...
                deliverer.AvailableAt = time + fullTripTime;
                cyclists.offer(deliverer);
