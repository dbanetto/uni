 ...
 */
public class GreaterEqOP extends ProgramOperator implements Expression {
    ...
    private GreaterEqOP(Expression left, Expression right) {
        this.left = left;
        this.right = right;
    }
    ...
    protected Expression parseCondition(Expression left, ProgramStack stack, Scanner scanner) {
        ...
        return new GreaterEqOP(left, right);
    }
