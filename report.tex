...
those more experienced with Ruby on Rails. During the first iteration Cameron
Price and I worked to create the skeleton the application. % FIXME: names? + add about testing
...
date on the project. However the turn out for the meetings were spotty,
especially when additional working meetings were held. This was
due to the differing schedules and courses between the members.
