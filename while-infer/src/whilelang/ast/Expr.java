...
public interface Expr extends SyntacticElement {
    ...
    public static class IndexOf extends SyntacticElement.Impl implements
         ...
         *
         * @param source     The source expression which generates a list value; may
         *                   not be null.
         * @param index      The index expression which determines the list element to
    ...
    public static class Unary extends SyntacticElement.Impl implements Expr {
         ...
         * sub-expression.
         *
         * @param op         The unary operation this expression represents; may not be
         *                   null.
         * @param expr       The sub-expression whose value will be manipulated by the
    ...
    public static class ArrayInitialiser extends SyntacticElement.Impl implements
         ...
         * element expressions.
         *
         * @param arguments  A list of zero or more element expressions; may not be
         *                   null.
         * @param attributes
         */
    ...
    public static class RecordAccess extends SyntacticElement.Impl implements
         ...
         * and field name.
         *
         * @param source     An expression which must evaluate to a record containing a
         *                   field with the given name; may not be null.
         * @param name       The name of a field contained within the record that the
    ...
    public static class RecordConstructor extends SyntacticElement.Impl
         ...
         *
         * @param fields     A map of zero or more field names to generating
    ...
    public static class Invoke extends SyntacticElement.Impl implements Expr,
         ...
         *
         * @param name       The function name that this invocation will call; may not
         *                   be null.
         * @param arguments  The list of zero or more argument expressions; may not be
         *                   null.
         * @param attributes
         */
