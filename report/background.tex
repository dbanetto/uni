...
Whiley also supports type invariants and aliasing, such as the \code{nat} type in
...
In this section there are three features leveraged to generate loop invariants.
...
\todo{is this needed? Probably not}
