...
public class DNSDB {
    ...
    private FileBPlusTreeStringToInt ipAddresses;
    private FileBPlusTreeIntToString hostNames;

    public DNSDB() {
        try {
            hostNames = new FileBPlusTreeIntToString("hostnames.bplus", 4096);
            ipAddresses = new FileBPlusTreeStringToInt("ipaddress.bplus", 4096);
    ...
    public void testAllPairs(File file) {
        ...
        System.out.println("IP: " + missing_ip + " / " + count + " missing");
        System.out.println("Host: " + missing_host + " / " + count + " missing");
    }
}
