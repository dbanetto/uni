...
software development to be executed in a sequential order:

% should this be a list or just comma separated?
\begin{enumerate}
...
Each stage closes off with an artifact that does not change from the rest of
the development.
