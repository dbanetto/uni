...
public class Location {
    ...
    public static final double CENTRE_LON = 174.763444;
    public static final Location CENTRE = Location.newFromLatLon(CENTRE_LAT, CENTRE_LON);
	...
	public double distance(Location other) {
		return Math.hypot(this.x - other.x, this.y - other.y) / 1000.0;
	}
