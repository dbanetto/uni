...
public class KeySpaceTest {
    ...
    public void writeToStream() throws Exception {
        ...
        // Assert
        Assert.assertArrayEquals(new byte[] {0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x0a}, output.toByteArray());
    }
    ...
    public void writeToStreamLarge() throws Exception {
        ...
        // Assert
        Assert.assertArrayEquals(new byte[] {0x00, 0x00, 0x00, 0x00, 0x11, 0x11, 0x11, 0x11}, output.toByteArray());
    }

    @Test
    public void readFromStream() throws Exception {
        // Arrange
        ByteArrayInputStream input = new ByteArrayInputStream(new byte[] {0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x0a});
