...
public interface Stmt extends SyntacticElement {
    ...
    public static final class IfElse extends SyntacticElement.Impl implements
         ...
         * @param trueBranch  A list of zero or more statements to be executed when the
         *                    condition holds; may not be null.
         * @param falseBranch A list of zero of more statements to be executed when the
    ...
    public static final class Switch extends SyntacticElement.Impl implements Stmt {
         ...
         *
         * @param expr       The expression whose generated value is used to match
         *                   cases against
    ...
    /**
     * Represents a variable declaration which does not immediately have its type, a
     * variable name and an (optional) initialiser expression. If an initialiser
     * is given, then this will be evaluated and assigned to the variable when
     * the declaration is executed. Some example declarations:
     * <p>
     ...
     * @author David J. Pearce
     */
    public static final class VariableInferredDeclaration extends SyntacticElement.Impl implements
            Stmt {
        private final String name;
        private final Expr expr;
        private Type type = new Type.Inferred();
         ...
         * @param attributes
         */
        public VariableInferredDeclaration(String name, Expr expr,
                                           Attribute... attributes) {
            super(attributes);
            this.type = type;
            this.name = name;
        ...
        public void setType(Type inferred) {
            this.type = inferred;
        }
